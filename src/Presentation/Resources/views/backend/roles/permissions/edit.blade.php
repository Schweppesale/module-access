...
@section('content')
    <div id="filters_show">
        <div class="container">
            <div class="row">
                {!! Form::model($permission, ['route' => ['admin.access.roles.permissions.update', $permission->id], 'class' => '', 'role' => 'form', 'method' => 'PATCH']) !!}
                ...
                <div class="col-md-12 create-issue-descript">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="general">
                            ...
                            </div> <!-- col-md-6 names end _____________________  -->
                            ...
                            </div> <!-- col-md-6  groups end _____________________ -->
                            ...
                            <div class="form-group col-md-6 role-checkbox-sort">
                                ...
                                <div class="col-md-12 role-checkbox-sort">
                                    @if (count($roles) > 0)
                                        @foreach($roles as $role)
                                            <div class="col-md-4">
                                                <input type="checkbox"
                                                       {{$role->id == 1 ? 'disabled' : ''}}
                                                       {{in_array($role->id, $permission_roles) || ($role->id == 1) ? 'checked' : ""}}
                                                       value="{{$role->id}}" name="permission_roles[]"
                                                       id="role-{{$role->id}}"/>
                                    ...
                                    @else
                                        No Roles to set
                                    @endif
                                </div><!-- col -12 checkboxes -->
                            </div><!--form control-->
                        </div> <!-- general tab ends_____________________________________________________ -->


                        <div role="tabpanel" class="tab-pane" id="dependencies">
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle"></i>
                                This section is where you specify that this permission depends on the user having one or
                                more other permissions.<br/><br/>
                        ...
                        </div> <!-- dependant tab ends_____________________________________________________ -->


                    </div><!-- tab content ends -->
                </div> <!--general styling ends -->
