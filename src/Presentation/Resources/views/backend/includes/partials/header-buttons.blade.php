<div class="pull-left peggy-access-manage">
    ...
    <div class="btn-group">
        <button type="button" class="btn dropdown-toggle create-filters save-filter" data-toggle="dropdown"
                aria-expanded="false">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right" role="menu">
            ...
            <li><a href="{{route('admin.projects.access.create')}}">Create Project Permissions</a></li>
            @endauth
