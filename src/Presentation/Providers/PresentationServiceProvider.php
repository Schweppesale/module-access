...
class PresentationServiceProvider extends ServiceProvider
{
    ...
    {
        $this->module = (new Repository($this->app))->findOrFail('Access');
    }
...
//		);
    ...
    public function registerViews()
    {
        ...
        $sourcePath = $this->module->getPath() . '/src/Presentation/Resources/views';

        $this->publishes([
            $sourcePath => $viewPath
        ]);

        $this->loadViewsFrom($sourcePath, 'access');
    }
